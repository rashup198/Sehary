...
const Footer = () => {
  return (
    <footer className='bg-black -pb-100'>
      ...
      <div className='pl-4 md:pl-100 pr-4 md:pr-100 pb-4'>
        <div className='flex gap-6 pl-[20px] flex-col md:flex-row md:space-x-6 lg:space-x-12'>
          <div className='md:w-1/4'>
            <h1 className='text-white text-[30px] p-[10px] md:text-2xl font-extrabold pb-3'>
              Navigation
            </h1>
            <ul className=' '>
              <li className='p-[10px]'>
          ...
          <div className='md:w-1/4'>
          <h1 className='text-white text-[30px] font-extrabold p-[10px]'>Services</h1>
          ...
          <div className='md:w-1/4'>
          <h1 className='text-white text-[30px] font-extrabold p-[10px]'>Product</h1>
          ...
          <div className='md:w-1/4'>
          <h1 className='text-white text-[30px] font-extrabold p-[10px]'>Other</h1>

            <ul className=''>
            <li className='p-[10px]'>
               <a href='https://wa.me/+918889947761' target='blank' class="hover:underline underline-offset-2 text-white ">Message us</a>
            </li>
            <li className='p-[10px]'>
